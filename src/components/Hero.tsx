  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        ...
        style={{ transform: 'translate(-50%, -50%)', left: '-9999px', top: '-9999px' }}
      />
        ...
        <div className="container grid md:grid-cols-2 items-center gap-10 relative z-10">
          ...
          >
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                href="#projects"
                className="glow-tile inline-flex items-center gap-2 rounded-2xl px-5 py-3 bg-brand text-white hover:bg-brand-600 transition shadow-soft"
              >
              ...
              <a
                href="/resume.pdf"
                download
                className="glow-tile inline-flex items-center gap-2 rounded-2xl px-5 py-3 border border-black/10 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/10 transition"
              >
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* Avatar / Showcase with glow/hover */}
